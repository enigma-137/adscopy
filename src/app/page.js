  ...
  return (
    <div className="container mx-auto p-4">
      <div className="max-w-md mx-auto bg-white p-8 border shadow-lg  rounded-md">
        <h2 className="text-2xl font-semibold mb-4 text-center">Ad Copy <span className='bg-purple-200'> Generator</span></h2>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full border rounded-md py-2 px-3 focus:outline-none focus:border-purple-500"
          />
        </div>
